...
class Main{
  public static void main(String[] args){
    ...
    for(int t = 0; t<testcase; t++){
      ...
      long rupee=1;
      System.out.println(check(num,rupee)?"Yes":"No");
    }
  }
  public static boolean check(long num,long rupee){
    if(rupee == num) return true;
    else if(rupee > num) return false;
   if(check(num,rupee*10)) return true;
    if(check(num, rupee*20)) return true;
    return false;
  }
}
